<nav class="navbar">
  ...
  <div class="input-group-text">
    ...
    <div class="row g-0 p-1">
      ...
      <div class="col-3 text-center">
        <a href="{{route('adminProfile')}}" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="instagram" class="icon-lg mb-1"></i><p class="tx-12">Profile</p></a>
      </div>
    </div>
        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{(!empty($profileDataUser->photo))?url('/upload/adminImages/'.$profileDataUser->photo):url('/uploads/no_image.jpg')}}"  alt="profile">
                </a>
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{(!empty($profileDataUser->photo))?url('/upload/adminImages/'.$profileDataUser->photo):url('/uploads/no_image.jpg')}}" alt="">
                        </div>
                        <div class="text-center">
                            <p class="tx-16 fw-bolder">{{$profileDataUser->name}}</p>
                            <p class="tx-12 text-muted">{{$profileDataUser->email}}</p>
                        </div>
                    </div>
    <ul class="list-unstyled p-1">
      ...
      <li class="dropdown-item py-2">
        <a href="{{{route('ChangePasswordPage')}}}" class="text-body ms-0">
